...
\section{Generating data for trio logic regression input}
...
specifying the length of the blocks is therefore also contained in this package.
...
\end{verbatim}
if \texttt{foundBlocks} is the output of \texttt{findLDblocks}.
...
Support was provided by NIH grants R01 DK061662 and R01 HL090577.
